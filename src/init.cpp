...
/** Sanity checks
 *  Ensure that EBITS is running in a usable environment with all
...
{
    // Make sure only a single EBITS process is using the data directory.
...
bool AppInitMain()
{
    ...
    // ********************************************************* Step 11c: update block tip in EBITS modules
