...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all EBITS related functionality
...
/*
    ...
    allow endless transaction that would bloat EBITS and make it unusable. To
...
{
    if(fLiteMode) return; // disable all EBITS specific functionality
