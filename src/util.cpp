...
const char * const BITCOIN_CONF_FILENAME = "ebits.conf";
const char * const BITCOIN_PID_FILENAME = "ebits.pid";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\EBITS
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\EBITS
    // Mac: ~/Library/Application Support/EBITS
    // Unix: ~/.bitcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "EBITS";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/EBITS";
#else
    // Unix
    return pathRet / ".EBITS";
#endif
#endif
}
