...
static const CAmount GOVERNANCE_PROPOSAL_FEE_TX = (25.0*COIN);

static const int64_t GOVERNANCE_FEE_CONFIRMATIONS = 3;
...
static const int GOVERNANCE_TRIGGER_EXPIRATION_BLOCKS = 14400;
