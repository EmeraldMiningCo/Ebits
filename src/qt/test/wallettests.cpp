...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<EBITSAmountField*>("payAmount")->setValue(amount);
    /*
...
void TestGUI()
{
    ...
    QString balanceComparison = EBITSUnits::formatWithUnit(unit, balance, false, EBITSUnits::separatorAlways);
    ...
    // Amount input
    EBITSAmountField* amountInput = receiveCoinsDialog.findChild<EBITSAmountField*>("reqAmount");
