    ...
    mapper(0)
{
    ...
    ui->openEBITSConfButton->setToolTip(ui->openEBITSConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new EBITSUnits(this));
...
void OptionsDialog::on_openEBITSConfButton_clicked()
{
