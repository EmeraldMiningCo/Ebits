...
/** EBITS unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class EBITSUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit EBITSUnits(QObject *parent);
...
typedef EBITSUnits::Unit EBITSUnit;
